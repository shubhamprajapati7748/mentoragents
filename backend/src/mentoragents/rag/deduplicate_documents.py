...
class DeduplicateDocuments:
    def remove_duplicates(self, documents: List[Document], threshold: float = 0.7) -> List[Document]:
    ...
    def find_duplicates(
        self, documents: List[Document], threshold: float = 0.7, num_perm: int = int(settings.RAG_CHUNK_SIZE * 0.5)
